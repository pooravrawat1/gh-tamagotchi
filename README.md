...
*The pet above is generated by the [update-pet workflow](.github/workflows/update-pet.yml). Run it once (Actions → "Update GitHub Tamagotchi Pet" → Run workflow) if the image is missing.*
